...
def load_gas_data(consumos_path, importes_path, year):
    ...
    try:
        ...
        # --- AJUSTE: Normalizar nombres de columnas a minúsculas ---
        ...
        # --- AJUSTE: Detectar columnas de meses dinámicamente ---
        ...
        # Renombrar columnas para consistencia con el resto de la app
        df_gas.rename(columns={'descripción': 'Centro', 'provincia': 'Provincia'}, inplace=True)
